...
public:
  static GetElementPtrInst *Create(Type *PointeeType, Value *Ptr,
    ...
    if (!(cast<PointerType>(Ptr->getType()->getScalarType())
               ->isOpaqueOrPointeeTypeMatches(PointeeType))) {
      llvm::errs()<<"PointeeType = "<<*PointeeType<<" : "<<PointeeType<<"\n";
      llvm::errs()<<"Ptr->getType() = "<<*Ptr->getType()->getScalarType()<<" : "<<Ptr->getType()->getScalarType()<<"\n";
    }
